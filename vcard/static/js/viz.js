...
function initialize (){
    ...
    d3.json("/api/allstories", function (error, entries) {
        ...
        d3.selectAll("a").on("click", function() {
            ...
            if (this.text == "Show stories from past month")
            {
                d3.select("#popup").style("display", "none");
                nopulse =  true;
                select_recent();
            ...
            else if (this.text == "Teens" || this.text == "Virgin" || this.text == "Queer" || this.text == "Male" || this.text == "Female" || this.text == "Straight")
            {
                select_tag(this.text.toLowerCase(), "demographic");
                nopulse =  true;
                d3.selectAll("a").attr("class","unselected");
                this.setAttribute("class", "selected");
                return false;
            }
            else if (this.text == "20s")
            {
                select_tag("twenties", "demographic");
                nopulse =  true;
                d3.selectAll("a").attr("class","unselected");
                this.setAttribute("class", "selected");
                return false;
            ...
            else if (this.text == "30s")
            {
                select_tag("thirties", "demographic");
                nopulse =  true;
                d3.selectAll("a").attr("class","unselected");
                this.setAttribute("class", "selected");
                return false;
            ...
            else if (this.text == "40s")
            {
                select_tag("forties", "demographic");
                nopulse =  true;
                d3.selectAll("a").attr("class","unselected");
                this.setAttribute("class", "selected");
                return false;
            ...
            else if (this.text == "50s")
            {
                select_tag("fifties", "demographic");
                nopulse =  true;
                d3.selectAll("a").attr("class","unselected");
                this.setAttribute("class", "selected");
                return false;
            ...
            else if (this.text == "60s")
            {
                select_tag("sixties", "demographic");
                nopulse =  true;
                d3.selectAll("a").attr("class","unselected");
                this.setAttribute("class", "selected");
                return false;
            ...
            else if (this.text == "Non-Virgin")
            {
                select_tag("not a virgin", "demographic");
                nopulse =  true;
                d3.selectAll("a").attr("class","unselected");
                this.setAttribute("class", "selected");
                return false;
